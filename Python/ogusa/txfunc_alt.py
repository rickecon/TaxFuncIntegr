...
def wsumsq(params, *args):
    ...
    --------------------------------------------------------------------
    '''
    coef1, coef2, max_rate, min_rate = params
